...
export class FilterOperator extends EnumValueObject<Operator> {
  ...
  public isPositive (): boolean {
    return this.valueOf !== Operator.NOT_EQUAL.valueOf && this.valueOf !== Operator.NOT_CONTAINS.valueOf
  }
  ...
  public isContainsOrNotContains (): boolean {
    return this.valueOf() === Operator.CONTAINS.valueOf() || this.valueOf() === Operator.NOT_CONTAINS.valueOf()
  }
}
